        ...
        <div className="prose max-w-none">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-5 mb-4">
              ...
              <li>
                You grant FitFlash a non-exclusive, worldwide, royalty-free
          ...
          <section className="mb-8">
            ...
            <p className="mt-2">
              ...
              professional. FitFlash is not responsible for any injuries or
          ...
          <section className="mb-8">
            ...
            <p className="mt-2">
              FitFlash is provided on an "as is" and "as available" basis
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              use of FitFlash after such changes constitutes your acceptance of
              the new terms.
            </p>
          </section>
